  ...
  <div class="row">
    ...
    <div class="col-md-4 col-xs-4 col-sm-3 col-md-2">
      <div class="card">
         <?php
          ...
          $query = "SELECT * FROM product where id=66 ";
    ...
    <div class="col-md-4 col-xs-4 col-sm-3 col-md-2">
      <div class="card">
         <?php
          $conn = mysqli_connect("localhost","id13014500_root","chaimaelmejgari","id13014500_ex_db");
          $query = "SELECT * FROM product where id=67 ";
            $result = mysqli_query($conn,$query);
            if(mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_array($result)) { ?>
                        <form method="post" action="cart.php?action=add&id=<?php echo $row["id"]; ?>">
    ...
    <div class="col-md-4 col-xs-4 col-sm-3 col-md-2 ">
      <div class="card">
         <?php
          $conn = mysqli_connect("localhost","id13014500_root","chaimaelmejgari","id13014500_ex_db");
          $query = "SELECT * FROM product where id=68 ";
            $result = mysqli_query($conn,$query);
            if(mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_array($result)) { ?>
                        <form method="post" action="cart.php?action=add&id=<?php echo $row["id"]; ?>">
  ...
  <div class="row">
    ...
    <div class="col-md-4 col-xs-4 col-sm-3 col-md-2">
      <div class="card">
        <?php
          $conn = mysqli_connect("localhost","id13014500_root","chaimaelmejgari","id13014500_ex_db");
          $query = "SELECT * FROM product where id=69 ";
            $result = mysqli_query($conn,$query);
            if(mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_array($result)) { ?>
                        <form method="post" action="cart.php?action=add&id=<?php echo $row["id"]; ?>">
    ...
    <div class="col-md-4 col-xs-4 col-sm-3 col-md-2">
      <div class="card">
         <?php
          $conn = mysqli_connect("localhost","id13014500_root","chaimaelmejgari","id13014500_ex_db");
          $query = "SELECT * FROM product where id=70 ";
            $result = mysqli_query($conn,$query);
            if(mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_array($result)) { ?>
                        <form method="post" action="cart.php?action=add&id=<?php echo $row["id"]; ?>">
    ...
    <div class="col-md-4 col-xs-4 col-sm-3 col-md-2 ">
      <div class="card">
        <?php
          $conn = mysqli_connect("localhost","id13014500_root","chaimaelmejgari","id13014500_ex_db");
          $query = "SELECT * FROM product where id=71 ";
            $result = mysqli_query($conn,$query);
            if(mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_array($result)) { ?>
                        <form method="post" action="cart.php?action=add&id=<?php echo $row["id"]; ?>">
